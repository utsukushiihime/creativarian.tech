              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="footer-widget footer-widget__about">
                    ...
                    <p>
                      <a href="mailto:info@creativarian.com">
                        info@creativarian.com
                      </a>{" "}
                      <br />
                      <a href="tel:469-751-7069">469 751 7069</a>
                    </p>
                  </div>
                </div>
          ...
          <div className="site-footer__bottom">
            <div className="container">
              <div className="inner-container">
                ...
                <p>© copyright 2020 by Creativarian.com</p>
              </div>
            </div>
          </div>
        </footer>
        ...
        <div className="side-menu__block">
          ...
          <div className="side-menu__block-inner ">
            ...
            <div className="side-menu__content">
              <p>
                Lorem Ipsum is simply dummy text the printing and setting
                industry. Lorm Ipsum has been the industry's standard dummy text
                ever.{" "}
              </p>
              <p>
                <a href="mailto:info@creativarian.com">info@creativarian.com</a>{" "}
